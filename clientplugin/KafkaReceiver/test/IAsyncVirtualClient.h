...
typedef void (*GVirtualClientService)(IAsyncVirtualClient* pPlugIn, void*handle, const void *, int);
...
{
public:
	virtual int Initialize(GVirtualClientService fnResponse, ExceptionWarn funcExceptionWarn, AsyncLog funcAsyncLog) = 0;
...
#endif //_I_ASYNC_VIRTUAL_CLIENT_H_
