...
public:
#ifdef WIN32
    virtual int Initialize(const string &strConfigFile, GVirtualClientService fnResponse, Response2BPE fnResponse2BPE, ExceptionWarn funcExceptionWarn, AsyncLog funcAsyncLog) = 0;
#else
