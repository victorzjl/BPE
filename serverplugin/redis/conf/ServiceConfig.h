...
typedef struct stConfigType
{
	...
	map<string, SConfigField> mapFieldByName;			//该参数中的field by name,针对requestParameter或responseParameter里的field或结构体里的field
	map<string, SConfigField> mapFieldByType;			//该参数中的filed by code,针对requestParameter或responseParameter里的field或结构体里的field
...
public:
	...
	ERedisType GetRedisType(){return m_eRedisType;}
	void Dump()const;
